...
.draw-round-info{display:flex;justify-content:space-between;align-items:center;gap:10px;padding:14px 20px;margin-bottom:10px;border-radius:999px;background:linear-gradient(135deg,#2fd66b,#16a34a);border:3px solid rgba(255,255,255,.35);color:#fff;font-weight:900;box-shadow:0 10px 26px rgba(22,163,74,.35),inset 0 0 0 1px rgba(255,255,255,.1)}
.draw-word-slot{font-size:21px;font-weight:1000;color:#fff;letter-spacing:1px;flex:1;text-align:center;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.draw-timer-pill{display:flex;align-items:center;gap:5px;background:#fff;color:#17a34a;font-weight:1000;font-size:17px;border-radius:999px;padding:8px 16px;box-shadow:0 4px 10px rgba(0,0,0,.18);flex:0 0 auto}
.draw-timer{color:#6de9ff;font-variant-numeric:tabular-nums}
.draw-timerbar-wrap{position:relative;flex:0 0 104px;height:34px;border-radius:14px;background:rgba(255,255,255,.25);overflow:hidden;box-shadow:inset 0 0 0 2px rgba(255,255,255,.35)}
.draw-timerbar-fill{position:absolute;top:0;left:0;bottom:0;width:100%;border-radius:14px;background:linear-gradient(90deg,#eafff0,#ffffff);transition:width 1s linear}
.draw-timerbar-fill.low{background:linear-gradient(90deg,#ffd9d9,#ffffff)}
.draw-timerbar-num{position:relative;z-index:2;display:flex;align-items:center;justify-content:center;gap:3px;height:100%;font-weight:1000;font-size:15px;color:#0e7c3c}
.draw-timerbar-fill.low+.draw-timerbar-num{color:#c62828}
.draw-players-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:9px;margin:10px 0}
